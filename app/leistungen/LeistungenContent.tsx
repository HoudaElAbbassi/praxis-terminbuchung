...
export default function LeistungenContent({ s }: { s: Settings }) {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-gray-700 font-medium px-2">
                {g("leistungen_hero", "Unsere Schwerpunkte im Bereich Gefäßmedizin")}
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <AccordionItem
                ...
                subtitle={g("leistungen_farbduplex", "Modernste Ultraschalltechnik für präzise Diagnostik")}
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <AccordionItem
                ...
                subtitle={g("leistungen_krampfadern", "Moderne, schonende Behandlung von Venenerkrankungen")}
              ...
              <AccordionItem
                ...
                subtitle={g("leistungen_cvi", "Langfristige Venenerkrankung mit gezielter Behandlung")}
              ...
              <AccordionItem
                ...
                subtitle={g("leistungen_tvt", "Ernstzunehmende Erkrankung mit schneller Diagnostik")}
              ...
              <AccordionItem
                title="Besenreiser"
                subtitle={g("leistungen_besenreiser", "Feine Venen – kosmetisch störend, aber behandelbar")}
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <AccordionItem
                ...
                subtitle={g("leistungen_pavk", "Häufige Gefäßerkrankung mit individueller Behandlung")}
              ...
              <AccordionItem
                ...
                subtitle={g("leistungen_carotis", "Frühzeitige Diagnostik zur Schlaganfallprävention")}
              ...
              <AccordionItem
                ...
                subtitle={g("leistungen_aneurysma", "Bauchaorta und Beinarterien – Kontrolle und Überwachung")}
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <AccordionItem
                title="Lymphödem"
                subtitle={g("leistungen_lymphoedem", "Differenzierte Diagnostik und langfristige Betreuung")}
            ...
            <div className="mb-12 sm:mb-16">
              ...
              <AccordionItem
                ...
                subtitle={g("leistungen_therapie", "Schonende Behandlung ohne Krankenhausaufenthalt")}
