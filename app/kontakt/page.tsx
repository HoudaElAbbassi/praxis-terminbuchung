      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="py-12 sm:py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 sm:mt-16">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-8" style={{fontFamily: "'Playfair Display', serif"}}>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-gray-900">Anna M.</h4>
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    "Sehr kompetente und freundliche Behandlung. Die Online-Terminbuchung funktioniert einwandfrei. Ich fühle mich hier sehr gut aufgehoben."
                  </p>
                  <p className="text-xs text-gray-500 mt-3">vor 2 Wochen</p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-gray-900">Michael K.</h4>
                      <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    "Herr Alyandouzi nimmt sich Zeit für seine Patienten und erklärt alles verständlich. Moderne Praxis mit top Ausstattung. Sehr zu empfehlen!"
                  </p>
                  <p className="text-xs text-gray-500 mt-3">vor 1 Monat</p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow">
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-gray-900">Sabine R.</h4>
                      <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    ...
                    <div className="text-xs font-bold text-pink-600 bg-pink-50 px-2 py-1 rounded">
                      Jameda
                    </div>
                  </div>
                  <p className="text-gray-700 text-sm leading-relaxed">
                    "Endlich ein Arzt, der zuhört! Kurze Wartezeiten, professionelle Untersuchung und eine sehr angenehme Atmosphäre. Die Praxis ist gut erreichbar."
                  </p>
                  <p className="text-xs text-gray-500 mt-3">vor 3 Wochen</p>
                </div>
              </div>

              <div className="mt-8 text-center">
                <p className="text-sm text-gray-600">
                  Durchschnittliche Bewertung: <span className="font-bold text-primary-600">4.9/5</span> aus über 50 Bewertungen
                </p>
              </div>
            </div>
          </div>
