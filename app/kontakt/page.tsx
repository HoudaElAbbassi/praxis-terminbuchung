      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4" style={{fontFamily: "'Playfair Display', serif"}}>
                Kontakt & <span className="text-[#2c5f7c]">Anfahrt</span>
              </h1>
        ...
        <section className="py-16 lg:py-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-[#2c5f7c] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="font-bold text-gray-900 mb-1">Praxis für Gefäßmedizin</h3>
                      <p className="text-gray-600">Remscheid</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <a href="tel:021916917400" className="text-[#2c5f7c] hover:underline text-lg">
                        02191 6917400
                      </a>
                    </div>
                  </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">02191 4694938</p>
                    </div>
                  </div>
                </div>

                {/* Sprechzeiten */}
                <div className="bg-gradient-to-br from-[#e8f4f2] to-white rounded-xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="text-gray-600">8:00 - 18:00 Uhr</span>
                        </div>
                        <div className="flex justify-between">
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-200">
                        <p className="text-sm text-gray-600">
                          <span className="font-semibold text-[#2c5f7c]">Termine nach Vereinbarung</span> – nutzen Sie gerne unser Online-Buchungssystem
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div>
                ...
                <div className="bg-gray-100 rounded-xl overflow-hidden shadow-sm border border-gray-200" style={{height: '400px'}}>
                  <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#e8f4f2] to-[#f7fafc]">
                    <div className="text-center p-8">
                      <svg className="w-16 h-16 text-[#2c5f7c] mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                      </svg>
                ...
                <div className="mt-6 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  <div className="flex items-start">
                    <svg className="w-6 h-6 text-[#2c5f7c] mr-3 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* CTA Section */}
            <div className="mt-16">
              <div className="bg-gradient-to-br from-[#2c5f7c] to-[#1f4459] rounded-2xl p-8 lg:p-12 text-white text-center">
