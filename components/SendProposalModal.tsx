...
export default function SendProposalModal({
  ...
  const translateUrgency = (urg: string | null | undefined): string => {
    if (!urg) return "Normal";
    const translations: Record<string, string> = {
      URGENT: "🔴 Dringend",
      NORMAL: "🟡 Normal",
      FLEXIBLE: "🟢 Flexibel"
    };
    return translations[urg] || urg;
  };

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-gradient-to-r from-[#4a9d8f] to-[#2c5f7c] p-6 rounded-t-xl">
        ...
        <div className="p-6">
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              <div>
                <span className="font-medium text-gray-700">Dringlichkeit:</span>
                <p className="text-gray-900 mt-1">{translateUrgency(urgency)}</p>
              </div>
            </div>
          </div>
          ...
          {specialRemarks && (
            <div className="bg-purple-50 border-l-4 border-purple-400 p-4 rounded mb-6">
              ...
              <p className="text-sm text-gray-700">{specialRemarks}</p>
            </div>
          )}
          ...
          <div className="bg-teal-50 border-2 border-teal-200 rounded-lg p-4 mb-6">
            <p className="text-sm text-teal-800">
              ...
              Der Patient erhält eine E-Mail mit dem Terminvorschlag und kann diesen annehmen oder ablehnen.
            </p>
          </div>
